...
| `INGEST_DOCLING_VLLM_TRUST_REMOTE_CODE` | `false` | `false` | Allows vLLM to execute remote model code where required. Keep disabled unless the model repository is trusted and verified. |
